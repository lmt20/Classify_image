...
class sift50_extract:

  def __init__(self):
    self.sift = cv.xfeatures2d.SIFT_create(50)
...
# path_input_image = "/media/lmtruong/01D557A8C9369F20/Work/JPEGImages"
# path_output_des = "/media/lmtruong/01D557A8C9369F20/Work/Feature_extract/sift50_extract"
# save_extract(path_input_image, path_output_des)
