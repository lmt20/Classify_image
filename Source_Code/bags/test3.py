...
a.append(b)
print(a)
# pathfile = "/media/lmtruong/01D557A8C9369F20/Work/JPEGImages/2007_000272.jpg"
# # pathfile = "/home/lmtruong/Pictures/img/2007_000027.jpg"
# img = cv.imread(pathfile, 0)
# img1 = cv.imread(pathfile)
# sift = cv.xfeatures2d.SIFT_create(100)
# kp, des = sift.detectAndCompute(img, None)
# print("size", kp[11].size)
# print(kp[11].pt[0])
# print(kp[11].pt[1])
...
# x = int(kp[10].pt[0])
# y = int(kp[10].pt[1])
# radius = int((kp[10].size)/2)

# if radius != 0:
#   sub_img = img1[y-radius:y+radius, x-radius:x+radius]
#   print(sub_img.shape)
#   cv.imshow("wd1",sub_img)
# # cv.waitKey(0)
...
# cm = cal_moment(sub_img)
# print(cm)
# cmi = cal_invariant_colormoments(sub_img)
# print(cmi)
# print(any(np.isnan(cmi)))
# if not any(np.isnan(cmi)):
#     print("LOL")
# print(len(cmi))